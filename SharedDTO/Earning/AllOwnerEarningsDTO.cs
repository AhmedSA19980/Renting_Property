...
{
    public class AllOwnerEarningsDTO
    {
        ...
        public AllOwnerEarningsDTO(int propertId, string countryName, decimal price, string discountPer, string name, bool isPropertyDeleted
